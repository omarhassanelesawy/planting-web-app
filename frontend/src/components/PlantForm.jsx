 ...
 * Props:
 *   onSubmit(payload) – called with the validated form data
...
export default function PlantForm({ onSubmit, onClose }) {
  ...
  /** Handle file input: convert to Base64 data URI */
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              rows={3}
              placeholder="e.g. Indirect light, mist weekly, avoid cold drafts"
